...
object IrrSummary {
  ...
  def apply(commands:Seq[AccountCommand], fromDate:LocalDate, queryDate:LocalDate, acctState: AccountState, balanceState: BalanceState, txState:TransactionState, priceState:PriceFXConverter, assetChainMap: AssetChainMap) : IrrSummary = {
