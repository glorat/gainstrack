...
class Auth0SavedJwkProvider(issuer: String) extends UrlJwkProvider(issuer) {
  ...
  override def getAll: java.util.List[Jwk] = {
    ...
    val inputStream = new StringReader(HARDCODE)
