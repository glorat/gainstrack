<template>
  <div>
    ...
    <div>
      <q-radio v-model="c.commandType" val="unit" label="Unit" />
      <q-radio v-model="c.commandType" val="bal" label="Balance" />
    </div>

    <div v-if="c.commandType==='bal'">
