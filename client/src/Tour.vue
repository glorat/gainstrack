...
<!--  import {AccountCommandDTO, AuthenticationDTO} from './lib/assetdb/models';-->
...
<!--    eventTest?: (e: string, c: AccountCommandDTO | RouteLocationNormalized | string) => boolean-->
...
<!--  function isRoute(c: AccountCommandDTO | RouteLocationNormalized | string): c is RouteLocationNormalized {-->
<!--    return (c as RouteLocationNormalized).path !== undefined;-->
<!--  }-->

<!--  function isAccountCommandDTO(c: AccountCommandDTO | RouteLocationNormalized): c is RouteLocationNormalized {-->
...
<!--  const routedToEventTest = (path: string) => (e: string, c: AccountCommandDTO | RouteLocationNormalized | string): boolean => {-->
<!--    return e === 'routed-to' && isRoute(c) && c.path === path;-->
<!--  };-->

<!--  const stringEventTest = (cmdType: string, payload: string) => (e: string, c: AccountCommandDTO | RouteLocationNormalized | string): boolean => {-->
